...
public class Array3 {
     ...
     * @return int, it is the largest span found in the given array. (Efficiency is not a priority.)
     */
     ...
     * @param nums int array
     * @return boolean, it is true if there is a place to split the array
     * so that the sum of the numbers on one side is equal to the sum of the numbers on the other side
     */
     ...
     *   seriesUp(2) → [1, 1, 2]
     * @param n int, it is non-negative number pattern {1,    1, 2,    1, 2, 3,   ... 1, 2, 3 .. n}
     * @return int array, it is
     */
     ...
     * @param nums int array
     * @return int array that contains exactly the same numbers as the given array, but rearranged
     ...
     * @param outer int array, it is sorted in increasing order
     * @param inner int array, it is sorted in increasing order
     * @return boolean, it is true if all of the numbers in inner appear in outer
     */
     ...
     * @param nums int array
     * @return int, it is the size of the largest mirror section found in the given array
     */
     ...
     * @param nums int array
     * @return int array that contains exactly the same numbers as the given array,
     * but rearranged so that every 4 is immediately followed by a 5.
     */
     ...
     * @return int array, what is the following pattern (ie:{0, 0, 1,    0, 2, 1,    3, 2, 1})
     */
     ...
     * @param nums int array
     * @return int, it is the number of "clump"
     */
