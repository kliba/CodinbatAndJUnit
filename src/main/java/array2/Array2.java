...
public class Array2 {
     ...
     * @return int, its counts all of the even elements f the nums and sum them
     */
     ...
     *   sum13([1, 2, 2, 1, 13]) → 6
     * @param nums int array
     * @return int, its 0 if the nums is empty or sum of the nums elements not including the unlucky number
     */
     ...
     *   lucky13([1, 2, 4]) → false
     * @param nums int array
     * @return boolean, its true if the array contains no 1's and no 3's
     */
     ...
     * @param n int
     * @return int array, containing array of length n, containing the numbers 0, 1, 2, ... n-1
     */
     ...
     *   no14([2, 3, 4]) → true
     * @param nums int array
     * @return boolean, its true if it contains no 1's or it contains no 4's
     */
     ...
     * @param nums1 int array with same length as the other param has
     * @param nums2 int array with same length as the other param has
     * @return int, it counts of the number of times that the two elements differ by 2 or less, but are not equal
     */
     ...
     * @param nums int array
     * @return boolean, its true if the array contains either 3 even or 3 odd values all next to each other
     */
     ...
     * @param nums int array
     * @param len int, it defines the iteration steps number
     * @return boolean, its true if the group of N numbers at the start and end of the array are the same
     */
     ...
     *   shiftLeft([1]) → [1]
     * @param nums int array
     * @return int array, its "left shifted" by one
     */
     ...
     * @param nums int array, its non-empty
     * @return int array, containing of all element after the last number 4 from the original array
     */
     ...
     * @param nums int array
     * @return int arra, it is a version of the given array where all the 10's have been removed. The remaining elements
     ...
     * @param start int, points to the 0th index of return array
     * @param end int, points to the last element of the return array
     * @return string array, containing the string form of these numbers,
     * except for multiples of 3, use "Fizz" instead of the number, for multiples of 5 use "Buzz",
     * and for multiples of both 3 and 5 use "FizzBuzz"
     */
     ...
     *   sum67([1, 1, 6, 7, 2]) → 4
     * @param nums int array
     * @return int, it is he sum of the numbers in the array, except ignore sections of numbers starting
     ...
     *   sum28([1, 2, 3, 4]) → false
     * @param nums int array
     * @return boolean, it is true  if the sum of all the 2's in the array is exactly 8
     */
     ...
     *   only14([1, 1]) → true
     * @param nums int array
     * @return boolean, it is true if every element is a 1 or a 4
     */
     ...
     * @param nums int array
     * @param val int, its the number should be found min 2 times in the nums array
     * @return boolean, it is true if the given value is everywhere in the array
     */
     ...
     * @param nums int array
     * @return boolean, it is if the array contains two 7's next to each other, or there are two 7's separated
     * by one element
     */
     ...
     * @param nums int array
     * @return boolean, it is true if the value 3 appears in the array exactly 3 times, and no 3's are next to each other
     */
     ...
     * @param nums int array
     * @return boolean, it is true if the array contains, somewhere, three increasing adjacent numbers
     */
     ...
     * @param nums int array
     * @return int array, containing all the values following it to be that multiple of 10,
     ...
     *   notAlone([3, 4], 3) → [3, 4]
     * @param nums int array
     * @param val int, it is the number that has to be checked
     * @return int array, it is a version of the given array where every instance of the given
     * value which is alone is replaced by whichever value to its left or right is larger
     */
     ...
     *   zeroMax([0, 1, 0]) → [1, 1, 0]
     * @param nums int array
     * @return int array, it is a ersion of the given array where each zero value in the array is replaced by the largest
     * odd value to the right of the zero in the array, if there is no odd value to the right of the zero,
     * leaving the zero as a zero
     */
     ...
     * @param nums int array
     * @return int, its value is the "centered" average of an array of ints, which we'll say is the mean average of the values,
     ...
     *   has22([2, 1, 2]) → false
     * @param nums int array
     * @return boolean, it is true if the array contains a 2 next to a 2 somewhere
     */
     ...
     *   more14([1, 1]) → true
     * @param nums int array
     * @return boolean, it is true if the number of 1's is greater than the number of 4's
     */
     ...
     *   fizzArray2(2) → ["0", "1"]
     * @param n int
     * @return string array, its length is n, containing the strings "0", "1" "2" ..
     * through n-1. N may be 0, in which case just return a length 0 array
     */
     ...
     * @param nums int array
     * @return boolean, it is true if the array contains a 2 next to a 2 or a 4 next to a 4, but not both
     */
     ...
     * @param nums int array
     * @return boolean, it is true if there is a 1 in the array with a 2 somewhere later in the array
     */
     ...
     * @param nums int array
     * @return boolean, it is true if every 2 that appears in the array is next to another 2
     */
     ...
     *   fizzArray3(1, 3) → [1, 2]
     * @param start int, it is the start number of the iteration
     * @param end int, it is the end number of the iteration
     * @return int array, it is containing the sequence of integers from start up to but not including end
     */
     ...
     *   pre4([3, 1, 4]) → [3, 1]
     *   pre4([1, 4, 4]) → [1]
     * @param nums int array, it is non-empty
     * @return int array, its containing the elements from the original array
     ...
     *   zeroFront([1, 0]) → [0, 1]
     * @param nums int array
     * @return int array, contains the exact same numbers as the given array, but rearranged so that all
     * the zeros are grouped at the start of the array
     */
     ...
     *   evenOdd([2, 2, 2]) → [2, 2, 2]
     * @param nums int array
     * @return int array, it contains the exact same numbers as the given array,
     * but rearranged so that all the even numbers come before all the odd numbers
     */
