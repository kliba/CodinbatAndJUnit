...
public class Logic1 {
     ...
     * @param cigars int, defines the smoked cigar number
     * @param isWeekend boolean, it is true if the current day is weekend
     * @return boolean, it is true if the party with the given values is successful
     */
     ...
     * @param speed int, it defines the speed
     * @param isBirthday boolean, it us true if the current day is birthday
     * @return int, it could be 0, 1 or 2. If speed is between 61 and 80 inclusive, the result is 1. If speed is 81 or more, the result is 2.
     * Unless it is your birthday -- on that day, your speed can be 5 higher in all cases.
     */
     ...
     * @param a int
     * @param b int
     * @return boolean, it is true true if either one is 6 or if their sum or difference is 6
     */
     ...
     *   more20(21) → true
     *   more20(22) → true
     * @param n int, none-negative number
     * @return boolean, it is true if the given non-negative number is 1 or 2 more than a multiple of 20
     */
     ...
     *   nearTen(17) → false
     *   nearTen(19) → true
     * @param num int, its a non-negative number
     * @return boolean, it is true if if num is within 2 of a multiple of 10
     */
     ...
     *   teaParty(3, 8) → 0
     *   teaParty(20, 6) → 2
     * @param tea int, defines how many teas are there
     * @param candy int, defines how many candies are there
     * @return int, it could be 0=bad, 1=good, or 2=great (1:if both tea and candy are at least 5 or
     * 2:if either tea or candy is at least double the amount of the other one or
     * 3: in all cases, if either tea or candy is less than 5 or
     * 0: every other hand)
     */
     ...
     * @param b int
     * @param c int
     * @return boolean, it is true if it is possible to add two of the ints to get the third
     */
     ...
     * @param a int, non-negative number
     * @param b int, non-negative number
     * @param c int, non-negative number
     * @return boolean, it is true if two or more of them have the same rightmost digit
     */
     ...
     * @param a int
     * @param b int
     * @return int, its if the two values are the same, return 0 or if the two values have the same remainder
     ...
     * @param b int
     * @param c int
     * @return int, If any pair sums to exactly 10, the result is 10.
     * Otherwise if the ab sum is exactly 10 more than either bc or ac sums, the result is 5.
     */
     ...
     *   dateFashion(5, 2) → 0
     *   dateFashion(5, 5) → 1
     * @param you int, it is in the range 0..10
     * @param date int, it is the stylishness of your date's clothes
     * @return int, it can be 0=no, 1=maybe, 2=yes (2:if either of you is very stylish, 8 or more or
     * 0:with the exception that if either of you has style of 2 or less or
     * 1: every other hand)
     */
     ...
     * @param a int
     * @param b int
     * @return int, it is the sum of a and b. However, sums in the range 10..19 inclusive,
     * are forbidden, so in that case just return 20.
     */
     ...
     * @return boolean, it is true if n is in the range 1..10, inclusive.
     * Unless outsideMode is true, in which case return true if the number is less or equal to 1,
     * or greater or equal to 10.
     */
     ...
     *   old35(10) → true
     *   old35(15) → false
     * @param n int, it is a non-negative number
     * @return boolean, its true if the given non-negative number is a multiple of 3 or 5, but not both
     */
     ...
     * @param a int
     * @param b int
     * @return int, its the sum od a and b. However, "teen" values in the range 13..19 inclusive,
     * are extra lucky. So if either value is a teen, just return 19
     */
     ...
     * @param str string
     * @return string, if the string starts with "f" return "Fizz". If the string ends with "b" return "Buzz".
     * If both the "f" and "b" conditions are true, return "FizzBuzz". In all other cases, return the string unchanged.
     */
     ...
     * @param c int
     * @param bOk boolean
     * @return boolean, its true if b is greater than a, and c is greater than b.
     * However, with the exception that if "bOk" is true, b does not need to be greater than a.
     */
     ...
     * @param b int
     * @param c int
     * @return boolean, its true if one of them is 10 or more less than one of the others
     */
     ...
     * @param b int
     * @param c int
     * @return int, each of the prams is 0, 1, or 2. If they are
     * all the value 2, the result is 10. Otherwise if they are all the same, the result is 5.
     * Otherwise so long as both b and c are different from a, the result is 1. Otherwise the result is 0.
     */
     ...
     * @param a int, it is in the range 10..99
     * @param b int, it is in the range 10..99
     * @return boolean, it is true if there is a digit that appears in both numbers,
     ...
     * @return boolean, it is true if the squirrels play
     */
     ...
     * @param day int, eg: 0=Sun, 1=Mon, 2=Tue, ...6=Sat
     * @param vacation boolean, its true if the current day is vacation
     * @return string, its if "7:00" indicating when the alarm clock should ring.
     * Weekdays, the alarm should be "7:00" and on the weekend it should be "10:00".
     * Unless we are on vacation -- then on weekdays it should be "10:00" and weekends it should be "off"
     */
     ...
     * @param n int, its non-negative number
     * @return boolean, its true if the given non-negative number is special
     */
     ...
     * @return boolean, its true if the given non-negative number is 1 or 2 less than a multiple of 20
     */
     ...
     * @param isMorning boolean, its true if there is morning
     * @param isMom boolean, its true if mom calls
     * @param isAsleep boolean, it is true if you are sleeping
     * @return boolean, it is true if you should answer it. Normally you answer, except in the morning
     * you only answer if it is your mom calling. In all cases, if you are asleep, you do not answer.
     */
     ...
     *   fizzString2(3) → "Fizz!"
     * @param n int
     * @return string, its form of the number followed by "!". So the int 6 yields "6!".
     * Except if the number is divisible by 3 use "Fizz" instead of the number, and if the number
     * is divisible by 5 use "Buzz", and if divisible by both 3 and 5, use "FizzBuzz".
     */
     ...
     * @param b int
     * @param c int
     * @param equalOk boolean, it is true if equal is allowed
     * @return boolean, its true if they are in strict increasing order, such as 2 5 11, or 5 6 7,
     * but not 6 5 7 or 5 5 7. However, with the exception that if "equalOk" is true, equality is allowed.
     */
     ...
     * @return int, its sum of two 6-sided dice rolls, each in the range 1..6.
     * However, if noDoubles is true, if the two dice show the same value, increment one die to the next value,
     * wrapping around to 1 if its value was 6.
     */
     ...
     * @param b int
     * @param c int
     * @return int, its 0:if the numbers are all different from each other or
     * 20:if all of the numbers are the same or
     * 10:if two of the numbers are the same
     */
     ...
     * @param a int, non-negative number
     * @param b int, non-negative number
     * @return int, its their sum, so long as the sum has the same number of digits as a.
     * If the sum has more digits than a, just return a without b.
     */
